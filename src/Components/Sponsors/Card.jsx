      ...
      <div className="relative bg-red-600 rounded-lg pb-2.5 flex flex-col gap-0.5 aspect-7/10">
        <div className="bg-white rounded-t-md p-0.5 flex items-center space-x-1">
          <div className="bg-white rounded-full p-0.5">
            <img src={firstPokemon} alt="" className="w-4 h-4 object-contain" />
          </div>
          <div className="bg-white rounded-full p-0.5">
            <img src={pokeball1} alt="" className="w-4 h-4 object-contain" />
          </div>
          <div className="bg-white rounded-full p-0.5">
            <img src={pokeball2} alt="" className="w-4 h-4 object-contain" />
          </div>
          <div className="bg-white rounded-full p-0.5">
            <img src={pokeball3} alt="" className="w-4 h-4 object-contain" />
          </div>
        </div>
        ...
        <div className="bg-white rounded-md grow flex items-center justify-center p-2 mt-1 md:mt-2 sm:p-4 mx-2.5 border-2 border-black">
          <img src={logoImage} alt="" className="object-contain h-16 sm:h-30" />
        </div>
