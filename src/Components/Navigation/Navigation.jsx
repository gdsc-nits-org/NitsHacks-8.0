      ...
      <div className="w-1/2 relative">
        <button
          ...
          className={`absolute w-full top-[40%] left-[20%] lg:top-[23%] lg:left-[15%] -rotate-20 transition-all duration-500 ${
            isAnimating
              ? "rotate-0 md:rotate-0 lg:rotate-0 scale-[3] md:scale-[3] lg:scale-[2.278] z-50 translate-x-[35%] md:translate-x-[35%] lg:translate-x-[35%]"
              : ""
          }`}
        >
          <img
            ...
            alt="nintendo"
          />
          <div className="absolute group w-[80%] h-[110%] -top-[5%] left-[10%] bg-black overflow-hidden z-10 flex justify-center items-center pointer-events-none">
            <h1 className="font-pocket-monk text-5xl underline text-[#968718] opacity-0 animate-fadeIn">
              Tracks
            </h1>
          </div>
        </button>
