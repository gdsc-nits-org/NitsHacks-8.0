    ...
    >
      <div className="footer-container">
          ...
          <div className="footer-left">
            ...
            <div className="contact-section">
              ...
              <div className="social-icons">
                <a href="https://www.instagram.com/nitshacks?igsh=MXFlbXY5azd6YTJi" target="_blank" rel="noopener noreferrer">
                  <img src={instagramIcon} alt="Instagram" className="icon" />
                </a>
                <a href="https://in.linkedin.com/in/nitshacks" target="_blank" rel="noopener noreferrer">
                  <img src={linkedinIcon} alt="LinkedIn" className="icon" />
                </a>
                <a href="https://www.facebook.com/NITSHacks/" target="_blank" rel="noopener noreferrer">
                  <img src={facebookIcon} alt="Facebook" className="icon" />
                </a>
                <a href="https://x.com/nitshacks?lang=en" target="_blank" rel="noopener noreferrer">
        ...
        <div className="footer-bottom">
          ...
          <p>
            Copyright 2025, Nits Hacks 8.0, National Institute of Technology,
            Silchar
          </p>
        </div>
      </div>
