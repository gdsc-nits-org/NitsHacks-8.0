    ...
    >
      <div className="main-stack">
        <div className="error-text-div">
          <img src={errorText} alt="Error" className="error-text-img" />
        </div>

        <div className="psyduck-section">
          <img src={number4Left} alt="4" className="psyduck-section-img-4" />
          <img src={psyduck} alt="Psyduck" className="psyduck-section-img-psyduck" />
          <img src={number4Right} alt="4" className="psyduck-section-img-4" />
        </div>
        ...
        <div className="home-button-div">
          <button onClick={handleBackToHome} className="home-button">
            <img src={buttonFrame} alt="Button Frame" className="home-button-frame" />
            <img src={buttonText} alt="Back to Home" className="home-button-text" />
          </button>
        </div>
      </div>
    </div>
